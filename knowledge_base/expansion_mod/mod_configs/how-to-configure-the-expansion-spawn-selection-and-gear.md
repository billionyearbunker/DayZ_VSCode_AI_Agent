# How to Configure the Expansion SpawnSelection and Gear

---

## Setting up Spawn Selection
...
REMOVE the , for the last classname of each "list" of items you will make (look at the example at the end of the page).
...
1 = Yes
0 = No
EquipementSlots (for example Headgear)
...
1 = Yes, it will use the config from this file
0 = No, it won't use the config from this file
UseXXXGear (for example UseUpperGear)
...
UsePrimaryWeapon and UseSecondaryWeapon
...
SpawnEnergyValue and SpawnWaterValue

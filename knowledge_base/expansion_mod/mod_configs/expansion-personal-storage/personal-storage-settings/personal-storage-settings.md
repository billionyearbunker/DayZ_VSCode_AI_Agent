...
- **Type**: Boolean
- **Description**: Enable\disable the personal storage system

### **`UsePersonalStorageCase`**

- **Type**: Boolean
- **Description**: Enable\disable the personal storage case system

### **`MaxItemsPerStorage`**

- **Type**: Integer
- **Description**: Maximum amount of items per storage a player can deposit. This will only count main items and not their attachments or cargo items!

...
- **Type**: Float
- **Description**: A perimeter surrounding a territory to prevent other territories to be built in. It will prevent territories to overlap if the value set is the same as TerritorySize or higher
- **Reference**: [perimeter sheet](https://example.com/perimeter)

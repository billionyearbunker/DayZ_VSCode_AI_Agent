...
- **Type**: Bool
- **Requirements**: Only work if `EnableGravecross` is enabled
- **Values**:
...
- **Type**: Integer
- **Requirements**: Only works if `EnableGravecross` is enabled
...
### **`EnableGenerators`**
- **Type**: Bool
- **Status**: CURRENTLY DOESNT WORK. However you can spawn yourself this generators as events!
- **Values**:

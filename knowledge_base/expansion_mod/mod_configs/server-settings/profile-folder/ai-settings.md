...
### **`Admins`**
- **Type**: TStringArray
- **Description**: A list of steam id in quotes to allow access to a debug menu for AI
- **Reference**: For more information [Click here](../../expansion-ai/how-to-access-the-ai-menu.md)
...
### **`PreventClimb`**
- **Type**: TStringArray
- **Description**: A list of objects classnames the AI shouldn't be able to climb. For example `Land_Mil_Airfield_HQ` (this one is hardcoded)

---

### **`PlayerFactions`**
- **Type**: TStringArray
- **Description**: A list of Factions in quotes. One of this listed factions will be randomly assigned to new players
- **Reference**: For more information [Click here](../../expansion-ai/how-to-assign-a-player-to-a-faction.md)

...
"PoorItemRequirement"
Integer<ExpansionHardlineItemRarity>.
...
Need to be a valid entity class name and a reputation value that should get added or deducted from the player when eliminating the certain entity. Can be a base class name or a specific one

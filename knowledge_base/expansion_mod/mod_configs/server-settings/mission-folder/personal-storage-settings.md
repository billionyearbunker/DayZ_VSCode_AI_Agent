...
### **`Enabled`**
- **Type**: Boolean
- **Description**: Enable\disable the personal stroage system

---

### **`UsePersonalStorageCase`**
- **Type**: Boolean
- **Description**: Enable\disable the personal stroage case system

---

### **`MaxItemsPerStorage`**
- **Type**: Integer
- **Description**: Maximum amount of items per storage a player can deposit. This will only count main items and not there attachments or cargo items!

---

### **`ExcludedClassNames`**
- **Type**: Array[String]
- **Description**: Class names of items that will never be displayed or be available to deposit in the personal storage

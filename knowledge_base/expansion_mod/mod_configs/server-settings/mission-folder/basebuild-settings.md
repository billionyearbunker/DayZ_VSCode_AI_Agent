...
- **Requirements**: Only used if AllowBuildingWithoutATerritory is set to 0
- **Description**: This list of classnames are the items you will be able to deploy outside the territories
...
- **Type**: Bool
- **Description**: Controls whether entering a wrong code lock password causes damage
...
- **Type**: Bool
- **Description**: Controls whether players can craft the territory flag kit
...
### **`SimpleTerritory`**
- **Type**: Bool
- **Description**: Controls whether the flag pole builds automatically or requires manual construction
...
- **Type**: Bool
- **Description**: Controls whether the flag is automatically added to the flag pole
...
- **Type**: Bool
- **Description**: Controls whether the player gets their kit back after building the territory flag
...
### **`Zones`**
- **Type**: Array
- **Description**: Array of non building zones
...
- **Type**: Bool
- **Description**: Controls whether zones are no-build zones or build-only zones
...
### **`CodelockAttachMode`**
- **Type**: Integer
- **Description**: Controls what items can have codelocks attached
...
### **`DismantleFlagMode`**
- **Type**: Integer
- **Description**: Controls who can dismantle flags and with what
...
### **`FlagMenuMode`**
- **Type**: Integer
- **Description**: Controls territory creation and flag customization

...
- **Type**: Boolean
- **Values**:
  - `0` = Disable the P2P market system
  - `1` = Enable the P2P market system

---

### **`MaxListingTime`**
- **Type**: Integer
- **Description**: Time in seconds how long a listed item stays on the market before it is deleted forever when the owner does not buy it back in time

---

### **`MaxListings`**
- **Type**: Integer
- **Description**: Maximum amount of listings per trader/market a player can list

---

### **`ListingOwnerDiscountPercent`**
- **Type**: Integer
- **Description**: Players can buy back their listings for a lower price than listed. This value sets the discount percent for the listing price

**Example** for a listing with a price of 1000 and a ListingOwnerDiscountPercent setting of 70:
```
(Price / 100) x ListingOwnerDiscountPercent
(1000 / 100) * 70 = 700 discount
```
In this example the listing owner can buy his listing back for 300.

---

### **`ListingPricePercent`**
- **Type**: Integer
- **Description**: Players need to pay a fee when putting on sale (listing) a item depending on the price they set on the listing. This value sets the fee percent for the listing price

**Example** for putting on sale (listing) with a price of 1000 and a ListingPricePercent setting of 30:
```
(Price / 100) x ListingPricePercent
(1000 / 100) * 30 = 300 fee
```
In this example the player needs to pay 300 to list a item for a price with 1000.

---

### **`ExcludedClassNames`**
- **Type**: Array[String]
- **Description**: Class names of items that will never be displayed or be available for listing in the P2P market
...
### **`MenuCategories`**
- **Type**: Array[ExpansionP2PMarketMenuCategory]
- **Description**: Menu categories for listed items
...
### **`SalesDepositTime`**
- **Type**: Integer
- **Description**: Time in seconds how long the sales of a purchesd listing will be saved before it is deleted forever when the owner does not retive his sale in time

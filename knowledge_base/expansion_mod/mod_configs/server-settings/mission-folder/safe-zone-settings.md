...
- **Type**: Bool
- **Description**: Controls whether items dropped in a safezone are automatically removed
- **Values**:
...
- **Type**: Bool
- **Description**: Controls whether vehicles are removed from safezones after their lifetime expires
- **Values**:
  - `0` = Vehicles won't be removed from safezones

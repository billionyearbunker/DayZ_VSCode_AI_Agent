...
**Note**: Traders will only act as traders if they are within the radius of a traderzone. NOTE that zones are spheres, so altitude for Position needs to be set correctly!
...
- **Type**: String
- **Description**: Market zone display name, can be what ever you want. Used for logging

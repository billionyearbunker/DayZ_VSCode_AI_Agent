...
Unlike most other settings that may not be map-specific, you can find the [MarketSettings.json](MarketSettings.json) in your `mpmission\dayzOffline.<mapname>\expansion\settings` folder.
...
- **Type**: Boolean
- **Description**: Enable or disable the Market system
- **Values**:
...
- **Type**: Array[ExpansionMarketSpawn]
...
Colors to be used for the market menu. If you would like to customize the style of the menu you can do that by changing the color values in this section.

**Format**: Hexadecimal RRGGBBAA, hexadecimal RGBA, or decimal R G B A with range 0-255 (alpha is optional in all cases)

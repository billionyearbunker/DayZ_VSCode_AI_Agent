...
- **`Name`**: Just tell the locations apart more easily and you can choose anything you like
- **`Type`**: Pre-filled from the entries in CfgWorlds, you can leave it empty when adding custom locations
...
**Important**: It is strongly recommended to leave the defaults intact and only add to this list.
...
**Warning**: Just an example, do NOT use this on your server.

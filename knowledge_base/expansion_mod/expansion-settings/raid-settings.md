...
- **Description**: Put every classname of the explosive items you want to be able to be used for raiding
- **Note**: The classnames are not the weapons items nor the explosives items but the explosion itself. For example you can disable rpg explosions with `Expansion_RPG_Explosion`
...
- **Type**: Float
- **Description**: It is a damage multiplier for all explosion type damages to Expansion base parts. For example with the default value of 50, a grenade that does 50 damage will do 50 * 50 damage to the wall, so 2500. For reference, vanilla grenades do 50 damage, Expansion rockets do 300, and C4 does 600. Less than 1 values work here as well, so 0x will disable damage to base parts, and .5x will halve them.
...
- **Type**: Float
- **Description**: It is a damage multiplier for all bullet type damages to Expansion base parts. For example with the default value of 2, a bullet that does 65 damage will do 65 * 2 damage to the wall, so 130. Less than 1 values work here as well, so 0x will disable damage to base parts, and .5x will halve them.
- **Note**: Walls currently have an HP of 30,000
...
- **Type**: Float
- **Description**: It is a damage multiplier for all explosion type damages to Expansion base parts. For example with the default value of 50, a grenade that does 50 damage will do 50 * 50 damage to the safe, so 2500. For reference, vanilla grenades do 50 damage, Expansion rockets do 300, and C4 does 600. Less than 1 values work here as well, so 0x will disable damage to base parts, and .5x will halve them.
- **Note**: Safes currently have 20,000 15,000 and 10,000 HP

---

### **`SafeProjectileDamageMultiplier`**
- **Type**: Float
- **Description**: It is a damage multiplier for all bullet type damages to Expansion base parts. For example with the default value of 2, a bullet that does 65 damage will do 65 * 2 damage to the safe, so 130. Less than 1 values work here as well, so 0x will disable damage to base parts, and .5x will halve them.
- **Note**: Safes currently have 20,000 15,000 and 10,000 HP
...
- **Type**: Integer
- **Description**: Time needed to raid lock on fence with tool

---

### **`LockOnTentRaidToolTimeSeconds`**
- **Type**: Integer
- **Description**: Time needed to raid lock on tent with tool

---

### **`LockRaidToolCycles`**
- **Type**: Integer
- **Description**: Number of cycles needed to raid lock

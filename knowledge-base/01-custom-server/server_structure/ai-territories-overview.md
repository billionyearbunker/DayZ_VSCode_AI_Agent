...
**`s` (Selection Weight, Integer):**
- Determines the probability of this zone being chosen relative to others.
...
**`x` / `z` (Floats):** The center point of the territory circle (Map Coordinates).

**`r` (Radius, Float):**
- The radius (in meters) around the center point.
